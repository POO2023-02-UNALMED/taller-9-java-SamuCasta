...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
	    ...
	    String boton_clicked = click.getText();

	    if ("+".equals(boton_clicked) || "-".equals(boton_clicked) || "*".equals(boton_clicked) || "/".equals(boton_clicked)) {
	        operator = boton_clicked;
	    } else if ("C".equals(boton_clicked)) {
	        operator = "";
	        number1 = "";
	        number2 = "";
	    } else if ("=".equals(boton_clicked)) {
